...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// If a value is nil then we know that no corresponding key/value pair was provided
	// in the JSON request body. So we move on and leave the movie record unchanged. Otherwise,
	// we update the movie record with the new value.
	if input.Title != nil {
